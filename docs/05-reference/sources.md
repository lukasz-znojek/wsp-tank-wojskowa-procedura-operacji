...
| [`docs/04-templates/bms.md`](../04-templates/bms.md) | `tank-skill-destylat/tank/szablon_bms.md` | metryka wpisu, rozdział źródła i widoku, kierunki przepływu, wyłączenia treści | przeniesione |
